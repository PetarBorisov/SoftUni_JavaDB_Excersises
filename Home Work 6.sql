...
-- 16
SELECT COUNT(*) as country_count FROM (SELECT 
...
SELECT 
    c.country_name,
    MAX(p.elevation) AS higest_peak_elevation,
...
ORDER BY higest_peak_elevation DESC , longest_river_lenght DESC , c.country_name
LIMIT 5;