...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllGoldenBooksTitleWithCopies() {
        return bookRepository.
    ...
    @Override
    public List<String> findAllBooksWithPriceLower5AndHiger40() {
        return bookRepository
    ...
    @Override
    public List<String> findAllBooksIsNotReleasedInThisYear(int year) {
    ...
    public List<String> findAllBooksReleasedBeforeDate(LocalDate localDate) {
        return bookRepository.findAllByReleaseDateBefore(localDate)
                .stream()
                .map(book -> String.format("%s %s %.2f",book.getTitle(),book.getEditionType()
                ,book.getPrice()))
                .collect(Collectors.toList());
    }

    @Override
    public List<String> bookSearch(String input) {
    ...
    @Override
    public List<String> findAllTittleWithLastNameStartWith(String input) {
